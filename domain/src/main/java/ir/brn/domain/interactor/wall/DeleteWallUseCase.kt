...
class DeleteWallUseCase @Inject constructor(
        private val wallRepository: WallRepository,
        postExecutionThread: PostExecutionThread) : ObservableUseCase<List<Wall>, DeleteWallUseCase.Params?>(postExecutionThread) {
    ...
    override fun buildUseCaseObservable(params: Params?): Observable<List<Wall>> {
        ...
        return wallRepository.deleteWall(params.wallId)
    }

    data class Params constructor(val wallId: Int) {
        companion object {
            fun forDeleteWall(wallId: Int): Params {
